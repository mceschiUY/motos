...
export const BUSQUEDA_ENTIDADES: BusquedaEntidad[] = [
  ...
  { api: 'meta', ruta: '/meta', label: 'Meta', icon: 'flag', campoTitulo: 'periodo', conEstado: false,
  ...
  { api: 'pedidolinea', ruta: '/pedidolinea', label: 'Línea de pedido', icon: 'list', campoTitulo: 'varianteDisplay', conEstado: false,
